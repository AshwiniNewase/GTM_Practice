...
public class Assignment171 
{
	...
	public static void main(String[] args) throws EncryptedDocumentException, IOException 
	{
		...
		String username=workbook.getSheet("Login Details").getRow(0).getCell(0).getStringCellValue();
		String password=workbook.getSheet("Login Details").getRow(0).getCell(1).getStringCellValue();
